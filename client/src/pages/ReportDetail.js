...
export default function ReportDetail() {
  ...
  async function load() {
    ...
    try {
      ...
      // 목표: goals 우선, 없으면 shortTermGoals 사용
      setGoals((data.goals || data.shortTermGoals) ?? "");
  ...
  async function save() {
    await updateReport(report._id, {
      ...
      // goals와 shortTermGoals를 함께 업데이트해 정합성 유지
      goals,
              ...
              <div className="info-section">
                ...
                <div className="content-display">
                  {report.actionPlans ? (
                    ...
                    <div className="empty-content">등록된 실행 계획이 없습니다.</div>
                  )}
                </div>
              </div>
