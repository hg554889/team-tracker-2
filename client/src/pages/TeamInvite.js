      ...
      if (inviteMethod === "email") {
        ...
        window.dispatchEvent(
          new CustomEvent("toast", {
            detail: {
              type: "success",
              msg: `${emails.length}명에게 초대장을 발송했습니다.`,
            },
          })
        );
      }
  ...
  if (myTeams.length === 0) {
    return (
      <div style={{ padding: "24px", textAlign: "center" }}>
        ...
        <h2
          style={{ fontSize: "24px", color: "#2c3e50", marginBottom: "16px" }}
        >
          리더 권한이 있는 팀이 없습니다
        </h2>
      ...
      >
        ...
        {inviteMethod === "email" && (
          <div style={{ marginBottom: "32px" }}>
            ...
            <button
              ...
              style={{
                background:
                  !emailList.trim() || sending ? "#95a5a6" : "#2ecc71",
                color: "white",
                border: "none",
                borderRadius: "8px",
                padding: "12px 24px",
                ...
                fontWeight: "600",
                cursor:
                  !emailList.trim() || sending ? "not-allowed" : "pointer",
                marginTop: "16px",
              }}
            >
              {sending ? "발송 중..." : "초대장 발송"}
        ...
        {inviteMethod === "link" && (
          <div style={{ marginBottom: "32px" }}>
            ...
            >
              ⚠️ 보안 안내: 이 링크는 3시간 후 자동으로 만료됩니다. 신뢰할 수
              있는 사람에게만 공유하세요.
            </div>
          </div>
        )}
        ...
        <div>
          <h3
            style={{ fontSize: "16px", color: "#2c3e50", marginBottom: "12px" }}
          >
            📊 최근 초대 현황
          </h3>
          <div
