    ...
    <div style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ margin: '0 0 8px 0', fontSize: '28px', color: '#2c3e50' }}>
              {user.username}
            </h1>
            <p style={{ margin: '0 0 8px 0', fontSize: '16px', color: '#636e72' }}>
              {user.email}
            </p>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ background: '#f8f9fa', padding: '16px', borderRadius: '8px' }}>
                    ...
                    <div>
                      <strong>최근 활동:</strong> {user.lastActivityAt ? new Date(user.lastActivityAt).toLocaleDateString() : 'N/A'}
                    </div>
                  </div>
                </div>
              </div>
