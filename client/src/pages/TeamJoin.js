    ...
    return (
      <div style={{ padding: "24px", maxWidth: "600px", margin: "0 auto" }}>
        ...
        >
          ...
          <h1
            style={{ fontSize: "28px", color: "#2c3e50", marginBottom: "16px" }}
          >
            팀 초대장
          </h1>

          <p
            style={{ fontSize: "18px", color: "#636e72", marginBottom: "32px" }}
          >
            <strong>{inviteInfo.inviterName}</strong>님이 당신을
            <br />
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            ...
            <button
              onClick={() =>
                handleJoinTeam(inviteInfo.teamId, inviteInfo.teamName)
              }
              disabled={joining}
              style={{
                flex: 2,
    ...
    <div style={{ padding: "24px", maxWidth: "800px", margin: "0 auto" }}>
      ...
      {availableTeams.length === 0 ? (
        ...
        >
          ...
          <h2
            style={{ fontSize: "20px", color: "#2c3e50", marginBottom: "16px" }}
          >
            참여 가능한 팀이 없습니다
          </h2>
          <p style={{ fontSize: "14px", color: "#636e72" }}>
            현재 참여할 수 있는 팀이 없습니다. 새로운 팀을 생성하거나 초대를
            기다려보세요.
          </p>
        </div>
      ) : (
