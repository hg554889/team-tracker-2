...
export default function AdminAnalytics() {
  ...
  const loadAnalytics = async () => {
    try {
      setLoading(true);
      const { data } = await client.get(`/admin/analytics?period=${selectedPeriod}`);
      setAnalytics(data);
    } catch (error) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <h3 style={{ margin: 0, fontSize: '18px', color: '#2c3e50' }}>전체 사용자</h3>
              <p style={{ margin: 0, fontSize: '12px', color: '#636e72' }}>등록된 사용자 수</p>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '32px', marginRight: '12px' }}>🚀</span>
            <div>
              <h3 style={{ margin: 0, fontSize: '18px', color: '#2c3e50' }}>활성 팀</h3>
              <p style={{ margin: 0, fontSize: '12px', color: '#636e72' }}>활동 중인 팀</p>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '32px', marginRight: '12px' }}>📊</span>
            <div>
              <h3 style={{ margin: 0, fontSize: '18px', color: '#2c3e50' }}>제출된 보고서</h3>
              <p style={{ margin: 0, fontSize: '12px', color: '#636e72' }}>이번 달 제출</p>
            </div>
          </div>
          <div style={{ fontSize: '28px', fontWeight: '700', color: '#9b59b6' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px' }}>
            <div style={{
              ...
              height: '150px',
              borderRadius: '50%',
              background: `conic-gradient(#2ecc71 0deg ${(mockData.teamActivity.active / mockData.teamActivity.total) * 360}deg, #e74c3c ${(mockData.teamActivity.active / mockData.teamActivity.total) * 360}deg 360deg)`,
              display: 'flex',
              alignItems: 'center',
              ...
              <div style={{
                ...
                <div style={{ fontSize: '24px', fontWeight: '700', color: '#2c3e50' }}>
                  {Math.round((mockData.teamActivity.active / mockData.teamActivity.total) * 100)}%
                </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <div style={{ width: '12px', height: '12px', background: '#2ecc71', borderRadius: '50%' }} />
              <span style={{ fontSize: '14px', color: '#636e72' }}>활성 ({mockData.teamActivity.active})</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <div style={{ width: '12px', height: '12px', background: '#e74c3c', borderRadius: '50%' }} />
              <span style={{ fontSize: '14px', color: '#636e72' }}>비활성 ({mockData.teamActivity.inactive})</span>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{
              ...
              <span style={{ fontSize: '18px', fontWeight: '600', color: '#2ecc71' }}>
                {mockData.reportStats.submitted}
              </span>
            </div>
            <div style={{
              ...
              <span style={{ fontSize: '14px', color: '#2c3e50' }}>대기 중</span>
              <span style={{ fontSize: '18px', fontWeight: '600', color: '#f39c12' }}>
